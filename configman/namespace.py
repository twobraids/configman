...
class Namespace(dotdict.DotDict):
    ...
    def __init__(self, doc=''):
        ...
        object.__setattr__(self, '_symbolic_link', False)
    ...
    def safe_copy(self):
        ...
        if self._symbolic_link:
            new_namespace.tag_as_symbolic_link()
    ...
    #--------------------------------------------------------------------------
    def tag_as_symbolic_link(self):
        """tag this namespace as having been created by the symbolic_link
        system for collecting common resources together."""
        object.__setattr__(self, '_symbolic_link', True)  # force into attributes
