...
"""
        ...
        def test_write_ini_with_symbolic_links_and_migration_turned_off(self):
            n = self._some_namespaces()
            n.namespace('x1')
            n.x1.add_option('password', 'secret "message"', 'the password',
                           symbolic_link='xxx.yyy')
            n.namespace('x2')
...
[xxx]
    ...
    # other sections of this ini file.  If they are common
...
[x1]
    ...
    # doc: the password
    # The following value has been automatically commented out because
    #   it is symbolically linked to another option. see:
