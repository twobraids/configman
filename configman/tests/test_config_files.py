...
class TestCase(unittest.TestCase):
    ...
    #----------------------------------------------------------------------
    def test_configdir_exists_and_default_config_exists_and_config_not_required(self):
        temp_config_dir = '/tmp'
    ...
    #----------------------------------------------------------------------
    def test_configdir_exists_default_config_exists_config_required_overridden_wrong(
        self
    ):
        temp_config_dir = '/tmp'
        with open('/tmp/dwight.ini', 'w') as f:
    ...
    def test_configdir_default_config_config_required_overridden_correctly(
        self
    ):
        temp_config_dir = '/tmp'
        with open('/tmp/dwight.ini', 'w') as f:
